...
export const HIDDEN_THEMES = [
  ...
  // هذان الموضوعان كانا أخضرَين بالكامل، فتبرز البطة البنّية بلونها وحده مهما
  // كبرت الشبكة: صعوبة الخانة تزيد بالحجم لا بالتشابه. أُدخلت رموز ترابية من
  // داخل الموضوع نفسه، متباعدةً بثلاثة مواضع في القائمة كي تلتقطها حصص الألوان
  // كلها. وحصة اللون تكبر مع الخانة، فتتدرّج الخلايا الترابية من خلية واحدة
  // وسط 16 في المبتدئ إلى نحو عشرين وسط 64 في الخانة الأخيرة: يبقى 200 سهلًا
  // باللون، ويصير 1000 بحثًا عن شكل لا عن لون.
  {
    topic: 'أوراق وأشجار',
    distinct: ['🌵', '🌴', '🌲', '🌳'],
    similar: ['🍂', '🍃', '🌿', '🍁', '☘️', '🍀', '🌰', '🌱', '🎍', '🎋'],
