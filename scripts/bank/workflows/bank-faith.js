export const meta = {
  name: 'bank-faith',
  description: 'Write the religious-knowledge packs as general information only, with no rulings and no disputed matters',
  phases: [
...
- ممنوع: السياسة والحكّام، الحروب الجارية، أي إحراج أو ما لا يناسب أطفالًا.
- **هذه فئة دينية، والقاعدة فيها: معلومات عامة فقط.** المسموح: الأسماء والأماكن والأحداث والأعداد والمصطلحات المتّفق عليها بين عامة المسلمين.
- **ممنوع منعًا باتًا**: الفتوى وأحكام الحلال والحرام، والمسائل الخلافية بين المذاهب أو العلماء، والمقارنة بين المذاهب أو الطوائف أو الأديان، والغيبيات المختلَف فيها، وأي سؤال قد يُحرج مسلمًا أو غير مسلم على مائدة العائلة.
- الشك في أن المسألة خلافية يعني لا تكتبها. اكتب ما يعرفه كل بيت مسلم ولا يختلف فيه اثنان.
- توقير في الصياغة: لا تهكّم ولا تبسيط مخلّ ولا صيغة امتحان.
...
6. **الملاءمة**: سياسة أو إحراج أو ما لا يناسب أطفالًا → drop.
6ب. **حدود الفئة الدينية**: أي فتوى أو حكم حلال وحرام، أو مسألة خلافية بين المذاهب أو العلماء، أو مقارنة بين مذاهب أو طوائف أو أديان، أو غيبيات مختلَف فيها → drop بلا تردد. المسموح أسماء وأماكن وأحداث وأعداد ومصطلحات متّفق عليها. الشك يعني drop.
