export const meta = {
  name: 'bank-story',
  description: 'Write drama, film and anime packs by sub-topic ownership under the in-work content rules',
  phases: [
...
قواعد إضافية إلزامية لفئات الأعمال الدرامية والأنمي والأفلام:
- **٨٠٪ فأكثر من أسئلتك عن أحداث داخل العمل نفسه**: الشخصيات وأسماؤها وعلاقاتها، الأماكن، الأحداث، الجمل الشهيرة، الأشياء والرموز داخل القصة.
- **٢٠٪ فأقل عن الممثلين أو المؤدّين**، وهذه محصورة في خانتي ٨٠٠ و١٠٠٠ وحدهما. لا سؤال عن ممثل في ٢٠٠ أو ٤٠٠ أو ٦٠٠ إطلاقًا.
- **ممنوع منعًا باتًا**: المخرجون، الكتّاب، الاستوديوهات، شركات الإنتاج، سنوات الإنتاج أو العرض، عدد الحلقات أو المواسم. لا سؤال واحد من هذا كلّه.
- لا حرق لنهاية العمل بصيغة مؤذية، ولا مشاهد عنف أو رعب موصوفة بتفصيل.`
...
6ب. **قواعد الأعمال**: أي سؤال عن مخرج أو كاتب أو استوديو أو شركة إنتاج أو سنة إنتاج أو عدد حلقات أو مواسم → drop بلا استثناء. وأي سؤال عن ممثل أو مؤدٍّ خارج خانتي 800 و1000 → drop. والسؤال يجب أن يكون عن أحداث داخل العمل نفسه.
